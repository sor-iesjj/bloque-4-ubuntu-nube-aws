#!/bin/bash
# =============================================================================
# BOOCHAN V3 - Aprovisionamiento de Samba AD DC (AWS)
# =============================================================================
...
# --- IP del servidor -------------------------------------------------------
# Esta maquina tiene MAS DE UNA interfaz: la de AWS y el tunel WireGuard
...
# Aqui se detecta la IP de AWS excluyendo el tunel y el loopback.
...
echo "     (si esa NO es la IP privada de tu servidor en AWS, aborta con Ctrl+C"
...
# red de AWS no lo sobrescriba en cada arranque. El 'chattr -i' inicial es
