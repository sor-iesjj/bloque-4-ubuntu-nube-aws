...
> - `ssh -i ~/boochan-key.pem ubuntu@TU_IP_ELASTICA`: Inicia sesión remota en el servidor como el usuario `ubuntu` (usuario por defecto de Ubuntu en AWS), usando la clave privada `.pem`.
